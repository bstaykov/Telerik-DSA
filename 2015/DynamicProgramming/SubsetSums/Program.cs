namespace SubsetSums
{
    ...
    public class Program
    {
        ...
        {
            var positiveNumbers = new int[] { 0, 1, 7, 3 };
            var possibleSums = FindPossibleSums(positiveNumbers);
            Console.WriteLine(string.Join(", ", possibleSums));

            var numbers = new int[] { -1, 1, -5, 1 };
            possibleSums = FindPossibleSumsWithNegative(numbers);
            Console.WriteLine(string.Join(", ", possibleSums));
        }
